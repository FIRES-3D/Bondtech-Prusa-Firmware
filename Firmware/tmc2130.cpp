...
//tmc2130_chopper_config_t tmc2130_chopper_config[4] = { // Known good values, but some salmon skin
//  {1.5, 2, 0, 2, 0}, // Half of original toff values since half steps? idk
//  {1.5, 2, 0, 2, 0},
//  {TMC2130_TOFF_XYZ, 5, 1, 2, 0},
//  {TMC2130_TOFF_E, 5, 1, 2, 0}
//};
...
void tmc2130_setup_chopper(uint8_t axis, uint8_t mres, uint8_t current_h, uint8_t current_r)
{
  ...
  //uint8_t intpol = 0; // Don't interpolate
